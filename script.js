const steps = document.querySelectorAll(".infoDiv");
const circleSteps = document.querySelectorAll(".step-div");
const formInputs = document.querySelectorAll(".step-1 form input");
const plans = document.querySelectorAll(".card-1");
const switcher = document.querySelector(".switch");
const addons = document.querySelectorAll(".tickBox");
...
plans.forEach((plan) => {
	plan.addEventListener("click", () => {
		...
		const planName = plan.querySelector("#did");
